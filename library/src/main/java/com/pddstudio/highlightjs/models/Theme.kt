...
sealed interface Theme {
    ...
    companion object {
        ...
        /**
         * Returns all predefined [Theme] instances (excludes [Custom]).
         * Provided for source-compatibility with the old enum [Theme.values()] call.
         */
        @JvmStatic fun values(): Array<Theme> = arrayOf(
            _1C_LIGHT, A11Y_DARK, A11Y_LIGHT, AGATE, AND_OLD_HOPE, ANDROID_STUDIO,
            ARDUINO_LIGHT, ARTA, ASCETIC, ATOM_ONE_DARK, ATOM_ONE_DARK_REASONABLE, ATOM_ONE_LIGHT,
            BROWN_PAPER, CODEPEN_EMBED, COLOR_BREWER,
            CYBERTOPIA_CHERRY, CYBERTOPIA_DIMMER, CYBERTOPIA_ICECAP, CYBERTOPIA_SATURATED,
            DARK, DEFAULT, DEVIBEANS, DOCCO, FAR, FELIPEC, FOUNDATION,
            GITHUB, GITHUB_DARK, GITHUB_DARK_DIMMED, GML, GOOGLECODE,
            GRADIENT_DARK, GRADIENT_LIGHT, GRAYSCALE,
            HYBRID, IDEA, INTELLIJ_LIGHT, IR_BLACK, ISBL_EDITOR_DARK, ISBL_EDITOR_LIGHT,
            KIMBIE_DARK, KIMBIE_LIGHT, LIGHTFAIR, LIOSHI, MAGULA, MONO_BLUE,
            MONOKAI, MONOKAI_SUBLIME, NIGHT_OWL, NNFX_DARK, NNFX_LIGHT, NORD, OBSIDIAN,
            PANDA_SYNTAX_DARK, PANDA_SYNTAX_LIGHT, PARAISO_DARK, PARAISO_LIGHT,
            POJOAQUE, PURE_BASIC, QT_CREATOR_DARK, QT_CREATOR_LIGHT, RAINBOW,
            ROSE_PINE, ROSE_PINE_DAWN, ROSE_PINE_MOON, ROUTEROS, SCHOOL_BOOK,
            SHADES_OF_PURPLE, SRCERY, STACKOVERFLOW_DARK, STACKOVERFLOW_LIGHT, SUNBURST,
            TOKYO_NIGHT_DARK, TOKYO_NIGHT_LIGHT, TOMORROW_NIGHT_BLUE, TOMORROW_NIGHT_BRIGHT,
            VS, VS2015, X_CODE, XT256
        )
    }
}
